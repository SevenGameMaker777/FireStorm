...
namespace gui
{
	...
	class FSGUITreeViewNode : public IGUITreeViewNode
	{
	friend class CGUITreeView;

	public:
		//! constructor
		FSGUITreeViewNode( FSGUITreeView* owner, FSGUITreeViewNode* parent );
...
//	private:
		...
		bool				Expanded;
		core::list<FSGUITreeViewNode*>	Children;
	};


	//! Default tree view GUI element.
	class FSGUITreeView : public IGUITreeView
	{
		friend class FSGUITreeViewNode;

	public:
		//! constructor
		FSGUITreeView(IGUIEnvironment* environment, IGUIElement* parent,
			s32 id, core::rect<s32> rectangle, bool clip = true,
			bool drawBack = false, bool scrollBarVertical = true, bool scrollBarHorizontal = true);

		//! destructor
		virtual ~FSGUITreeView();
		...
		IGUIScrollBar*		getHScrollbar() { return ScrollBarH; }
		IGUIScrollBar*		getVScrollbar() { return ScrollBarV; }
...
//	private:
		...
		IGUIScrollBar*		getHorizScrollbar() { return ScrollBarH; }
		IGUIScrollBar*		getVertScrollbar() { return ScrollBarV; }
