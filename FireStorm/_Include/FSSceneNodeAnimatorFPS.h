...
namespace irr
{
	...
	namespace scene
	{
		...
		class FSSceneNodeAnimatorFPS : public ISceneNodeAnimatorCameraFPS
		{
		public:

			//! Constructor
			FSSceneNodeAnimatorFPS(gui::ICursorControl* cursorControl,
			...
			//! Destructor
			virtual ~FSSceneNodeAnimatorFPS();
			...
			irr::core::vector2df getCursorOffset() 
			{ 
				return irr::core::vector2df(m_CursorOffsetX, m_CursorOffsetY);
			}
